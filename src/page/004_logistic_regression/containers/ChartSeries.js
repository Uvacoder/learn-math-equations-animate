...
function ChartSeries ({series}) {
  return <ResponsiveContainer>
    ...
    >
      ...
      <XAxis type="number" dataKey="x" name="stature" domain={[0, 15]}/>
      <YAxis type="number" dataKey="y" name="weight" />
      <Scatter data={series[0].data} fill="rgba(128,128,128, 0.85)" />
      <Scatter data={series[1].data} fill="rgba(196,196,196, 0.85)"/>
      <Line data={series[2].data} dot={false} dataKey="y" stroke="rgba(200,200,200,0.75)"/>
    </ComposedChart>
  </ResponsiveContainer>
}
